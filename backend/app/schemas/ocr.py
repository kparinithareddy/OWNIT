...
class OCRExtractedItem(BaseModel):
    ...
    price: Optional[float] = Field(None, ge=0.0, description="Extracted base price / subtotal")
    taxAmount: Optional[float] = Field(None, ge=0.0, description="Extracted GST or tax amount")
    totalPrice: Optional[float] = Field(None, ge=0.0, description="Grand total price inclusive of GST / taxes")
    ...
    sellerAddress: Optional[str] = Field(None, description="Detected merchant / store address")
    paymentMethod: Optional[str] = Field(None, description="Detected payment mode (e.g. Credit Card, UPI, Net Banking)")
...
class OCRScanResponse(BaseModel):
    ...
    sellerAddress: Optional[str] = Field(None, description="Overall detected store / company address")
    paymentMethod: Optional[str] = Field(None, description="Detected payment method or mode")
    ...
    subtotal: Optional[float] = Field(None, description="Detected subtotal / taxable amount before tax")
    taxAmount: Optional[float] = Field(None, description="Detected total GST / tax amount")
...
class OCRConfirmItem(BaseModel):
    ...
    taxAmount: Optional[float] = Field(None, ge=0.0)
    totalPrice: Optional[float] = Field(None, ge=0.0)
    quantity: int = Field(1, ge=1)
    seller: Optional[str] = Field(None, max_length=200)
    sellerAddress: Optional[str] = Field(None, max_length=300)
